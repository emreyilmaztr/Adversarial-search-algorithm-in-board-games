...
public class Mcts<A extends Action> implements ISearchAlgorithm {
    ...
    public A getAction(GameState gameState, User user) {
        ...
        MctsSearcher<A> searcher = new MctsSearcher<A>(this.EXPAND_THRESHOLD, this.TIME_LIMIT, this.C, this.rand.nextLong(), root);

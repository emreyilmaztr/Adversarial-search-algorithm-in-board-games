package searchAlgorithm.algorithm.expectimax;
...
public class Expectimax<A extends Action> implements ISearchAlgorithm {
    ...
    public Expectimax(int maximumDepth)
    {
    ...
    private double getNextMode(Node<A> node, User user, User opponent, int depth, boolean isMax)
    {
        ...
        else
        {
            ...
            return minUtility / children.size();
        }
    }

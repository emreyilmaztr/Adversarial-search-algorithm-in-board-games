...
public class CheckersMctsWithWuPlayer implements IPlayer {

    private int id;
    private User user;
    private MctsWithWu<CheckersAction> mcts;

    public CheckersMctsWithWuPlayer(User user, int id, int timelimit) {
        this.mcts = new MctsWithWu<CheckersAction>();

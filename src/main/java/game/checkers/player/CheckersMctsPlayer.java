...
public class CheckersMctsPlayer implements IPlayer {

    private int id;
    private User user;
    private Mcts<CheckersAction> mcts;

    public CheckersMctsPlayer(User user, int id, int timelimit) {
        this.mcts = new Mcts<CheckersAction>();

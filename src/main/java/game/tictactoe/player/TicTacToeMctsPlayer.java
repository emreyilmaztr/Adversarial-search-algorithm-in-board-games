...
public class TicTacToeMctsPlayer implements IPlayer {

    private int id;
    private User user;
    private Mcts<TicTacToeAction> mcts;

    public TicTacToeMctsPlayer(User user, int id, int timelimit) {
        this.mcts = new Mcts<TicTacToeAction>();
